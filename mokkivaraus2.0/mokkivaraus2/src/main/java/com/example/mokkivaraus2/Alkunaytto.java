...
public class Alkunaytto extends Application {
    ...
    // saagan tiedot älkää häkkeröikö !!!! "jdbc:mysql://localhost:3306/vn", "root", "Salasana1"
    private final String DB_URL = "jdbc:mysql://localhost:3306/vn";
    private final String DB_USER = "root";
    private final String DB_PASS = "Salasana1";
    ...
    private void lisaaAlue(String alueNimi) {
        //String query = "INSERT INTO alue (name) VALUES (?)";
    ...
    private void poistaAlue(String alueId) {
        String query = "DELETE FROM alue WHERE alue_id = ?";
        //jglkdjfkl
